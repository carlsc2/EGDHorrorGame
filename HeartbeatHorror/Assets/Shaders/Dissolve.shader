Shader "Custom/Dissolve" {
	Properties {
		...
		_DissolveIntensity("Dissolve Intensity", Range(0.0, 2.0)) = 0.0
	...
	SubShader{
		...
		void surf(Input IN, inout SurfaceOutput o){
			...
			float dissolveColor = snoise(IN.uv_MainTex * 10);
			half dissolveClip = 1 + dissolveColor - _DissolveIntensity;
